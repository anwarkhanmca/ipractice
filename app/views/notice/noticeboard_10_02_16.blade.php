...
@section('mycssfile')
<!-- Notice board staff holidays calender start -->
<link rel="stylesheet" type="text/css" media="screen" href="{{ URL :: asset('noticeboard/style.css') }}" />
<link rel="stylesheet" type="text/css" media="screen" href="{{ URL :: asset('noticeboard/includes/shadowbox-3.0.3/shadowbox.css') }}" />
<link rel="stylesheet" type="text/css" media="screen" href="{{ URL :: asset('noticeboard/includes/jquery-minicolors/jquery.miniColors.css') }}" />   
<!-- Notice board staff holidays calender end -->
...
<!-- Notice board staff holidays calender start -->
<!-- DATES MANAGEMENT -->
<script type='text/javascript' src='/noticeboard/includes/date.js'></script>
<script type='text/javascript' src='/noticeboard/eventouchcalendar.js'></script>
<script type="text/javascript">
  ...
  $(document).ready(function() {
    ...
    */
    ...
    // Call $agenda.redraw(); when the calendar's coordinates change (because events and masks have absolute position at this time)
		...
		<section class="content">
            ...
            <div class="notice_board_main">
              ...
              <ul>
                ...
                <li style="width:30%;" ><a href="/noticeboard/{{ '5' }}" class="{{ ($page_open == 5)?'tab_active':'' }} notice_tabhover">PDF Viewer</a></li>
              </ul>
              </div>
            </div>
