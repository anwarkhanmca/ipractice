				...
				<div class="tab_topcon">
			        <div class="top_bts">
			          <ul style="padding: 0px;">
						...
						<li>
							 <button class="btn btn-info" type="button" id="saveTemplateButton" data-save_as="F" data-status="T">Save As Template</button>
						</li>
            ...
            <div class="col-md-12" style="padding-left: 0px;">
				<div class="col-md-8">
					...
					<div class="form-group">
						  ...
						  <input name="template_mail_subject" id="template_mail_subject" type="text" class="form-control" placeholder="Subject Line">
					...
					<div class="form-group">
						<textarea name="template_message_body" id="template_message_body" class="form-control" placeholder="Message" style="height: 250px;">{{$templateBody or ''}}</textarea>
					</div>
			  	...
			  	<div class="col-md-4" style="margin-top: -23px;">
					<div class="input_dropdownbn">
						...
						<select class="form-control newdropdown" id="changePlaceHolder">
	                        ...
	                        <option value="address">Addresses Details</option>
	                    </select>
