...
@endif
  ...
  <thead>
    ...
    @if($service_id == 3)
      ...
      <th width="10%">LAST ACCTS FILED</th>
      <th width="10%">NEXT ACCOUNTS DUE</th>
      <th width="10%">S/OFF DATE</th>
      <th width="5%">DAYS</th>
    @endif

    @if($service_id == 4)
      <th width="28%">BUSINESS NAME</th>
      <th width="20%">VAT SCHEME</th>
      <th width="10%">TYPE</th>
      <th width="15%">STAGGER</th>
      <th width="15%">JOB FREQ</th>
      <th width="10%">Hrs/Wk</th>
    @endif

    @if($service_id == 5)
      <th width="12%">D0I</th>
      <th width="28%">BUSINESS NAME</th>
      <th width="12%">YEAR END</th>
      <th width="12%">LAST ACCTS FILED</th>
      <th width="12%">CT. REFERENCE</th>
      <th width="12%">TAX RETURN PERIOD</th>
      <th width="12%">DUE DATE</th>
      <th width="12%">COUNT DOWN</th>
    @endif

    @if($service_id == 7)
      <th width="10%">DOB/DOI</th>
      <th width="15%">CLIENT TYPE</th>
      <th width="25%">NAME</th>
      <th width="10%">NI NUMBER</th>
