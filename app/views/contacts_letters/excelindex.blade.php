<table border="1" style="width: 100%;margin-bottom: 20px; border-collapse: collapse;">
      ...
      <tr>
                ...
                <td>&nbsp;</td>
                <td colspan="4" height="30px" align="center"><p style="font-size: 18; text-decoration:underline; font-weight:bold;">
...
<table width="100%" border="1" cellspacing="0" cellpadding="0" style="line-height: 25px;">
      ...
      <thead>
        <tr role="row">
          ...
          <td width="20%" align="left"><strong>Contact Person</strong></td>
          <td width="20%" align="left"><strong>Telephone</strong></td>
         <td width="20%" align="left"><strong>Mobile</strong></td>
          <td width="20%" align="left"><strong>Email</strong></td>
          <td width="20%" align="left"><strong>Address</strong></td>
 ...
 <table width="100%" border="1" cellspacing="0" cellpadding="0" style="line-height: 25px;">
      <thead>
        <tr role="row">
          ...
          <th width="20%">Correspondence Address</th>
        </tr>
      </thead>
