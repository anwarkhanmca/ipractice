...
<script src="{{ URL :: asset('js/jtablejs/contacts.js') }}" type="text/javascript"></script>
@stop
        ...
        @if(isset($ind_details) && count($ind_details) >0)
          @foreach($ind_details as $key=>$client_row)
            <tr class="all_check">
              ...
              <!-- <td align="left">{{ (strlen($client_row['serv_address']) > 48)? substr($client_row['serv_address'], 0, 45)."...<a href='javascript:void(0)' class='more_address' data-client_id='".$client_row['client_id']."' data-address_type='serv' data-client_type='ind'>more</a>": $client_row['serv_address'] or '' }}</td> -->
