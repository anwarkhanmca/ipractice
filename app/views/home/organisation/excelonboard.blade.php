<table border="1" style="width: 100%;margin-bottom: 20px; border-collapse: collapse;">
      ...
      <tr>
                ...
                <td>&nbsp;</td>
                <td colspan="2" height="30px" align="center"><p style="font-size: 18; text-decoration:underline; font-weight:bold;">{{"CLIENT - ONBOARDING"}} </p></td>
      ...
      <input type="hidden" id="client_type" value="org"> 
        <thead>
            <tr role="row">
                ...
                <td width="12%" align="center" style="font-size: 15px;"><strong>Join Date</strong></td>
                <td width="10%" align="center" style="font-size: 15px;"><strong>Client Type</strong></td>
                <td width="18%" align="center" style="font-size: 15px;"><strong>Client Name</strong></td>
                <td width="15%" align="center" style="font-size: 15px;"><strong>Contact Name</strong></td>
                <td width="5%" align="center" style="font-size: 15px;"><strong>% Completed</strong></td>
                <td width="15%" align="center" style="font-size: 15px;"><strong>Telephone</strong></td>
                <td width="18%" align="center" style="font-size: 15px;"><strong>Email</strong></td>
                <td width="15%" align="center" style="font-size: 15px;"><strong>Mobile</strong></td>
            </tr>
        </thead>
