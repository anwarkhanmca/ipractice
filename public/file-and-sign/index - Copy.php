				...
				<div class="tabarea">
					<div class="nav-tabs-custom">
						<ul class="nav nav-tabs nav-tabsbg">
							<li class="active"><a data-toggle="tab" id="tab1documents" href="index.php">DOCUMENTS</a></li>
							<li class=""><a data-toggle="tab" id="tab1signanddoc" href="http://mpm.digiopia.in/fileandsign#tab_1">SIGN A DOCUMENT</a></li>
