...
.sigPad { width:324px; height:155px; border:2px solid #31B0D5; border-radius:5px;}
</style>
<!--[if IE]>
...
<body>
	...
	<div class="col-md-12 col-sd-12 col-xs-12">
		<div class="sigPad" id="canvas_box">
			<canvas id="canvas" width="320px" height="150px"></canvas>
		</div>
		<div class="sigPad" id="file_box">
			<input class="form-control" type="file" id="file-input" style="margin:60px 20px; width:90%;">
		</div>
		<script>
		...
		$(function() {
			...
			function fileOnload(e) {
				...
				$img.load(function() {
					context.drawImage(this, 0, 0, 320, 150);
				});
			}
		});
		</script>
