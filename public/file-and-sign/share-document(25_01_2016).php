...
<div id="tab_1" >
	...
	<table width="100%" class="table table-bordered">
		...
		<?php
			...
			$sel_doc = "select * from documents WHERE user_id=$user_id AND doc_status=2 AND signed_doc_status=1 LIMIT $start, $limit";
			...
			?>
				<tr>
					...
					<td align="center">
						<a href="<?=$SITE_URL?>signed-signature.php?delid=<?=$row_doc['id']?>" onClick="return conf_del();">
							<img src="images/cross.png" width="15">
						</a>
					</td>
				</tr>
			<?php }
				...
				<tr>
					<td colspan="6" align="center"><strong>There are no document signed yet.</strong></td>
				</tr>
			<?php } ?>	
					...
					<div class="closeand_download">
						<?php								
						$rows=mysql_num_rows(mysql_query("select * from documents WHERE user_id=$user_id AND doc_status=2 AND signed_doc_status=1"));
						if($rows > $limit) {
