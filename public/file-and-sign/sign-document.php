...
<html style="min-height: 813px;"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    ...
    <body class="skin-blue pace-done" style="min-height: 813px;"><div class="pace  pace-inactive"><div class="pace-progress" data-progress-text="100%" data-progress="99" style="width: 100%;">
...
<div class="col_display">
    <p class="display_name">Blick Rothenberg LLP </p>
</div>
    ...
    <div class="navbar-right">
        <ul class="nav navbar-nav">
            ...
            <li class="dropdown user user-menu">
                <a href="http://mpm.digiopia.in/fileandsign#" class="dropdown-toggle" data-toggle="dropdown">
                    <i class="glyphicon glyphicon-user"></i>
                    <span>JON LUKE <i class="caret"></i></span>
                </a>
                <ul class="dropdown-menu">
                    ...
                    <li class="user-footer">
                        ...
                        <div class="pull-left" style="margin-left: 3px;">
                            <a href="" class="btn btn-default btn-flat">Edit Password</a>
                        </div>
...
<div class="clearfix"></div>    
        ...
        <div class="wrapper row-offcanvas row-offcanvas-left" style="min-height: 667px;">
            ...
            <aside class="left-side sidebar-offcanvas collapse-left" style="min-height: 813px;">
					...
					<div class="tabarea">
						<div class="nav-tabs-custom">
					  		<ul class="nav nav-tabs nav-tabsbg">
								<li class="active"><a data-toggle="tab" id="tab1signanddoc" href="http://mpm.digiopia.in/fileandsign#tab_1">SIGN A DOCUMENT</a></li>
								<li class=""><a data-toggle="tab" id="tab2send" href="http://mpm.digiopia.in/fileandsign#tab_2">SEND FOR SIGNATURE</a></li>
								<li class=""><a data-toggle="tab" id="tab3signdocs" href="http://mpm.digiopia.in/fileandsign#tab_3">SIGNED DOCS</a></li>
								<li class=""><a data-toggle="tab" id="tab4sharefile" href="http://mpm.digiopia.in/fileandsign#tab_4">SHARE FILES WITH CLIENT PORTAL(DROPBOX LINKS)</a></li>
								<li class="chk_right">
								...
								<li style="float: right; display: none;" id="sharefiles">
									<a href="http://mpm.digiopia.in/fileandsign#" class=" btn-block btn-primary " data-toggle="modal" data-target="#compose-modal">
										<i class="fa fa-plus"></i> Share New Document
									</a>
								</li>
							</ul>
