																		...
																		$(document).ready( function() { 
																			...
																			$("#add_text_field").click(function () {
																				...
																				if(page == '<?php echo $page; ?>') {
																					...
																					txt_field.on("dblclick",function(){
																						if(confirm('Are you sure to delete this text?')) {
																							this.remove();
																							FieldLayer.draw();		
																						}
																					...
																					txt_field.on('mouseover', function() {
																						document.body.style.cursor = 'move';
																					});
																					
																					txt_field.on('mouseout', function() {
																						document.body.style.cursor = 'default';
																					});
																			...
																			$("#save_as_image").click(function() {
																				...
																				callback: function(dataUrl) {
																					$.post(
																						"ajax_image-multiple-with-signer.php", 
																						{ 
																							data : dataUrl, 
																							name: "<?php echo 'ds_files/jpg_files/'.$f['image_name']; ?>", 
																							doc_id: "<?php echo $d_id; ?>", 
																							next_id:"<?php echo $next_id; ?>", 
																							r_id:"<?php echo $r_id; ?>", 
																							page : <?php echo $page; ?>, 
																							total_page : <?php echo $total_page; ?>,
																							user : "<?php echo $signer; ?>" 
																						},
																						
																						function(data_<?php echo $page; ?>) { 
																						//alert(data_<?php echo $page; ?>)
																						console.log(data_<?php echo $page; ?>); //alert("Your Design Was Saved To The Server"); 
																							...
																							if('<?php echo $page; ?>' == '<?php echo $total_page; ?>') {
																								...
																								$('#save_as_image_msg').fadeIn('slow').delay(5000).fadeOut('slow');
																								setTimeout(function() {
