		...
		<div class="outer_div">
			...
			<div class="graph_box">
                <table class="table" style="margin-top: 70px;">
                    <thead>
                    <tr>
                        <td colspan="3" style="font-style: normal">KEY</td>
                    </tr>
                    </thead>
                    <tbody>
                    <?php 
                    $pipeline = getSalesPipeLine();
                    if(isset($pipeline['table_array']) && count($pipeline['table_array']) >0){
                        foreach ($pipeline['table_array'] as $key=>$value){
                    ?>
                    <tr>
                        <td style="text-align: left;">£<?php echo $value['total'];?></td>
                        <td><?php echo (strlen($value['tab_name'])>40)?substr($value['tab_name'], 0, 37).'...':$value['tab_name'];?></td>
                        <td style="text-align: left;"><?php echo $value['percentage'];?>%</td>
                    </tr>
                   <?php }}?> 
                    </tbody>
                </table>
        ...
        <div class="outer_div">
            ...
            <div class="graph_box">
                <table class="table" style="margin-top: 70px;">
                    ...
                    <tbody>
                   <?php 
                    $sales = getSalesLeadGraph();
                    if(isset($sales['table_array']) && count($sales['table_array']) >0){
                        foreach ($sales['table_array'] as $key=>$value){
                    ?>
                    <tr>
