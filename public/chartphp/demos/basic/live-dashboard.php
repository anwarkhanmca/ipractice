...
<html>
	<head>
        ...
        <style>
            ...
            .jqplot-title{font-size: 14px!important;}
            /*#c3 .jqplot-yaxis{display: none!important;}*/

            #c12 .jqplot-table-legend-label{font-size: 9px;}
            #c12{width: 100%!important}
            #c12 table{top: 3px!important;}
        </style>
           ...
           $('.delete_client').on('click', function(){
               ...
               if(confirm('Do you want to delete the client from table'))
               {
                $.ajax({
                   ...
                   data : {'client_id' : client_id, 'table_name': table_name, 'action':'crm_graph_table_delete'},
	...
	<body>
		<div class="outer_div">
			...
			<div class="table_box"><?php echo $growth_org_out; ?></div>
            <div class="graph_box"><?php echo $artition_org_mtr; ?></div>
        </div>
        
        <div class="outer_div">
            <div class="graph_box"><?php echo $total_ind_out; ?></div>
			<div class="graph_box"><?php echo $avg_ind_out; ?></div>
        ...
        <div class="outer_div"><!-- Pie Chart -->
            ...
            <div class="table_box" style="height: 350px;"><?php echo $industry_type; ?></div>
        </div>
        ...
        <div class="outer_div"><!-- Table -->
			<div class="table_box">
                <table class="table">
                    <thead>
                    <tr>
                        <td colspan="5">Newest 10 Clients Lost - Organisations</td>
                    </tr>
                    </thead>
                    <thead>
                    <tr>
        ...
        <div class="outer_div">
			<div class="table_box">
                <table class="table">
                    ...
                    ?>
                    <tr>
                        <td style="text-align: center;"><a href="javascript:void(0)" class="delete_client" data-table_name="renewal" data-client_id="<?php echo $value['client_id'];?>"><img src="../../../img/cross.png" height="12"></a></td>
                        <td><?php echo $value['client_name'];?></td>
			...
			<div class="table_box">
                <table class="table">
                    ...
                    ?>
                    <tr>
                        <td style="text-align: center;"><a href="javascript:void(0)" class="delete_client" data-table_name="onboarding" data-client_id="<?php echo $value['client_id'];?>"><img src="../../../img/cross.png" height="12"></a></td>
                        <td><?php echo $value['client_name'];?></td>
