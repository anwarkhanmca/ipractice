...
/* ========= Deals Won v Lost - Amount ========= */
$wonlost = new chartphp();
$wonlost->data = getWonLostGraph();
$wonlost->chart_type = "bar"; 
$wonlost->color = "yellow";
$wonlost->title = "Deals Won v Lost - Amount";  
$wonlost->options["axes"]["yaxis"]["tickOptions"]["prefix"] = '£'; 
$wonlost_out = $wonlost->render('c1');

/* ========= Deals Won v Lost - Count ========= */
$p2 = new chartphp();
//$p2->data = getWonLostGraph();
$p2->data = array(array(array('Won', 12),array('Lost', 9)));
$p2->chart_type = "bar"; 
$p2->color = "#ADD8E6";
$p2->title = "Deals Won v Lost - Count";  
$p2_out = $p2->render('c2');
...
$out_pipeline           = $pipeline->render('c3');
...
$deal_age->title      = "Average Deal Age"; 
$out_deal_age         = $deal_age->render('c6');

/* ========= Top 10 Oldest Open Opportunities ========= */
$oldopen_opp             = new chartphp(); 
//$details                 = getOldestOpportunity();//$details['graph_array'];
$oldopen_opp->data       = array(array(array('a',6), array('b',8)));
